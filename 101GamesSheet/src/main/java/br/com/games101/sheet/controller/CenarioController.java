...
public class CenarioController {
	...
	@GetMapping()
	public ResponseEntity<Page<CenarioResponseDTO>> listaCenario(@RequestParam int page, @RequestParam int quantidade){
		Pageable paginacao = PageRequest.of(page, quantidade);
		Page<CenarioResponseDTO> listaFichas = cenarioService.listaFichas(paginacao);
